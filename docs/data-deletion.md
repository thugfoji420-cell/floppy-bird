...
description: Neon Flap 2100 Data Deletion Instructions
...
This page explains how to request deletion of your personal data collected by Neon Flap 2100. We are committed to respecting your privacy and providing you with control over your personal information.

## What Data Will Be Deleted

When you submit a valid deletion request, we will permanently delete the following data associated with your account:
...
The following data is retained as described below:
...
Use the following exact subject line:

**Subject:** Data Deletion Request — Neon Flap 2100

### Step 3: Include Required Information

Your email must include the following information for us to locate and delete your data:

- **Your Player Name** (the name displayed in-game)
- **Your Google Account Email Address** (the email associated with your Google Sign-In)

Optional but helpful:
- Your approximate date of first use
- Any additional details that may help identify your account

### Step 4: Wait for Confirmation

After receiving your request, we will:

1. **Verify your identity** by matching the provided information against our records
2. **Process the deletion** within **30 days** of receiving a valid request
3. **Send you a confirmation email** once the deletion is complete

If we are unable to verify your identity based on the information provided, we may request additional information to confirm your identity before processing the deletion.

## Alternative: In-App Data Management
...
Some data is collected and stored by third-party services that we do not directly control. You may also wish to:
...
We may retain certain data if required to:
- Comply with applicable laws, regulations, or legal processes
- Resolve disputes or enforce our Terms of Service
- Protect against fraudulent or abusive activity

In such cases, only the minimum amount of data necessary for these purposes will be retained, and it will be deleted as soon as the retention purpose is fulfilled.

## Changes to These Instructions

We may update these Data Deletion Instructions from time to time. When we make material changes, we will update the "Last Updated" date at the top of this page.
